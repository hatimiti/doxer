...
public abstract class AbstractBsStShhnKnyMsCQ extends AbstractConditionQuery {
     ...
     * ST_SHHN_KNY_MS_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param minNumber The min number of stShhnKnyMsId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of stShhnKnyMsId. (basically NotNull: if op.allowOneSide(), null allowed)
     ...
     * ST_SHHN_KNY_MS_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param stShhnKnyMsIdList The collection of stShhnKnyMsId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * ST_SHHN_KNY_MS_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param stShhnKnyMsIdList The collection of stShhnKnyMsId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * KONYU_SU: {NotNull, DECIMAL(4)}
     * @param minNumber The min number of konyuSu. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of konyuSu. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param opLambda The callback for option of range-of. (NotNull)
     */
     ...
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * KONYU_SU: {NotNull, DECIMAL(4)}
     * @param konyuSuList The collection of konyuSu as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * KONYU_SU: {NotNull, DECIMAL(4)}
     * @param konyuSuList The collection of konyuSu as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * KONYU_UNIT_PRICE: {NotNull, DECIMAL(9)}
     * @param minNumber The min number of konyuUnitPrice. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of konyuUnitPrice. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param opLambda The callback for option of range-of. (NotNull)
     */
     ...
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * KONYU_UNIT_PRICE: {NotNull, DECIMAL(9)}
     * @param konyuUnitPriceList The collection of konyuUnitPrice as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * KONYU_UNIT_PRICE: {NotNull, DECIMAL(9)}
     * @param konyuUnitPriceList The collection of konyuUnitPrice as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
