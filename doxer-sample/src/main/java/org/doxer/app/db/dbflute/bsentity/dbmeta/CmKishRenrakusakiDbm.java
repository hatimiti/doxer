...
public class CmKishRenrakusakiDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((CmKishRenrakusaki)et).getRenrakusakiYotoKb(), (et, vl) -> {
            CDef.RenrakusakiYotoKb cls = (CDef.RenrakusakiYotoKb)gcls(et, columnRenrakusakiYotoKb(), vl);
            if (cls != null) {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnCmKishRenrakusakiId = cci("CM_KISH_RENRAKUSAKI_ID", "CM_KISH_RENRAKUSAKI_ID", null, null, Long.class, "cmKishRenrakusakiId", null, true, true, true, "BIGINT", 19, 0, null, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_AA1B608E_0FED_4CD9_8135_2D08C2443B3C", false, null, null, null, null, null, false);
    protected final ColumnInfo _columnCmKaishaId = cci("CM_KAISHA_ID", "CM_KAISHA_ID", null, null, Long.class, "cmKaishaId", null, false, false, true, "BIGINT", 19, 0, null, null, false, null, null, "cmKaisha", null, null, false);
    protected final ColumnInfo _columnTelNo1 = cci("TEL_NO1", "TEL_NO1", null, null, Integer.class, "telNo1", null, false, false, false, "DECIMAL", 5, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnTelNo2 = cci("TEL_NO2", "TEL_NO2", null, null, Integer.class, "telNo2", null, false, false, false, "DECIMAL", 5, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnTelNo3 = cci("TEL_NO3", "TEL_NO3", null, null, Integer.class, "telNo3", null, false, false, false, "DECIMAL", 5, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnMailAddress = cci("MAIL_ADDRESS", "MAIL_ADDRESS", null, null, String.class, "mailAddress", null, false, false, false, "VARCHAR", 253, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnRenrakusakiYotoKb = cci("RENRAKUSAKI_YOTO_KB", "RENRAKUSAKI_YOTO_KB", null, null, String.class, "renrakusakiYotoKb", null, false, false, true, "CHAR", 3, 0, null, null, false, null, null, null, null, CDef.DefMeta.RenrakusakiYotoKb, false);
    protected final ColumnInfo _columnRegUserId = cci("REG_USER_ID", "REG_USER_ID", null, null, String.class, "regUserId", null, false, false, true, "VARCHAR", 10, 0, null, null, true, null, null, null, null, null, false);
    protected final ColumnInfo _columnRegTm = cci("REG_TM", "REG_TM", null, null, java.time.LocalDateTime.class, "regTm", null, false, false, true, "TIMESTAMP", 23, 10, null, null, true, null, null, null, null, null, false);
    protected final ColumnInfo _columnRegFuncCd = cci("REG_FUNC_CD", "REG_FUNC_CD", null, null, String.class, "regFuncCd", null, false, false, true, "VARCHAR", 9, 0, null, null, true, null, null, null, null, null, false);
    protected final ColumnInfo _columnUpdUserId = cci("UPD_USER_ID", "UPD_USER_ID", null, null, String.class, "updUserId", null, false, false, true, "VARCHAR", 10, 0, null, null, true, null, null, null, null, null, false);
    protected final ColumnInfo _columnUpdTm = cci("UPD_TM", "UPD_TM", null, null, java.time.LocalDateTime.class, "updTm", null, false, false, true, "TIMESTAMP", 23, 10, null, null, true, null, null, null, null, null, false);
    protected final ColumnInfo _columnUpdFuncCd = cci("UPD_FUNC_CD", "UPD_FUNC_CD", null, null, String.class, "updFuncCd", null, false, false, true, "VARCHAR", 9, 0, null, null, true, null, null, null, null, null, false);
    protected final ColumnInfo _columnVersionNo = cci("VERSION_NO", "VERSION_NO", null, null, Integer.class, "versionNo", null, false, false, true, "DECIMAL", 9, 0, null, null, true, OptimisticLockType.VERSION_NO, null, null, null, null, false);
