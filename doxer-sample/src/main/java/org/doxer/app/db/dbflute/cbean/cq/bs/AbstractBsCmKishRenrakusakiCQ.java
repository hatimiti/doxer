...
public abstract class AbstractBsCmKishRenrakusakiCQ extends AbstractConditionQuery {
     ...
     * CM_KISH_RENRAKUSAKI_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param minNumber The min number of cmKishRenrakusakiId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of cmKishRenrakusakiId. (basically NotNull: if op.allowOneSide(), null allowed)
     ...
     * CM_KISH_RENRAKUSAKI_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param cmKishRenrakusakiIdList The collection of cmKishRenrakusakiId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * CM_KISH_RENRAKUSAKI_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param cmKishRenrakusakiIdList The collection of cmKishRenrakusakiId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * TEL_NO1: {DECIMAL(5)}
     * @param minNumber The min number of telNo1. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of telNo1. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param opLambda The callback for option of range-of. (NotNull)
     */
     ...
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * TEL_NO1: {DECIMAL(5)}
     * @param telNo1List The collection of telNo1 as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * TEL_NO1: {DECIMAL(5)}
     * @param telNo1List The collection of telNo1 as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * TEL_NO2: {DECIMAL(5)}
     * @param minNumber The min number of telNo2. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of telNo2. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param opLambda The callback for option of range-of. (NotNull)
     */
     ...
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * TEL_NO2: {DECIMAL(5)}
     * @param telNo2List The collection of telNo2 as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * TEL_NO2: {DECIMAL(5)}
     * @param telNo2List The collection of telNo2 as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * TEL_NO3: {DECIMAL(5)}
     * @param minNumber The min number of telNo3. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of telNo3. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param opLambda The callback for option of range-of. (NotNull)
     */
     ...
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * TEL_NO3: {DECIMAL(5)}
     * @param telNo3List The collection of telNo3 as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * TEL_NO3: {DECIMAL(5)}
     * @param telNo3List The collection of telNo3 as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * @param renrakusakiYotoKb The value of renrakusakiYotoKb as equal. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * RENRAKUSAKI_YOTO_KB: {NotNull, CHAR(3), classification=RenrakusakiYotoKb}
     * @param renrakusakiYotoKb The value of renrakusakiYotoKb as notEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * InScope {in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * RENRAKUSAKI_YOTO_KB: {NotNull, CHAR(3), classification=RenrakusakiYotoKb}
     * @param renrakusakiYotoKbList The collection of renrakusakiYotoKb as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    protected void setRenrakusakiYotoKb_InScope(Collection<String> renrakusakiYotoKbList) {
     ...
     * NotInScope {not in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * RENRAKUSAKI_YOTO_KB: {NotNull, CHAR(3), classification=RenrakusakiYotoKb}
     * @param renrakusakiYotoKbList The collection of renrakusakiYotoKb as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    protected void setRenrakusakiYotoKb_NotInScope(Collection<String> renrakusakiYotoKbList) {
