...
public class CmTesuryoKbDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((CmTesuryoKb)et).getKbVal(), (et, vl) -> {
            CDef.TesuryoKb cls = (CDef.TesuryoKb)gcls(et, columnKbVal(), vl);
            if (cls != null) {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnKbVal = cci("KB_VAL", "KB_VAL", null, null, String.class, "kbVal", null, true, false, true, "CHAR", 3, 0, null, null, false, null, null, null, "cmKishTesuryoList", CDef.DefMeta.TesuryoKb, false);
