...
public final class _Time {
  ...
  private static final String ZZERO = "00";
  private static final String RZERO = ":" + ZZERO;
  private static final String LZERO = ZZERO + ":";
	...
	public static Time getFromHh(String hh) {
		try {
			return Time.valueOf(hh + RZERO + RZERO);
		} catch (Throwable t) {
			return null;
		}
	}
	...
	public static Time getFromMm(String mm) {
		try {
			return Time.valueOf(LZERO + mm + RZERO);
		} catch (Throwable t) {
			return null;
		}
	}
